...
def init_logger():
    ...
    fh = logging.handlers.RotatingFileHandler(filename="./logs/logs_celery.log", maxBytes=1000000, backupCount=10)
    fh.setLevel(logging.INFO)
    fh.setFormatter(formatter)
    fh.addFilter(password_token_filter)

    file_handler = logging.handlers.RotatingFileHandler("./logs/logs_celery_error.log", maxBytes=1000000, backupCount=10)
